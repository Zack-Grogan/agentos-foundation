...
Input: [input.md](input.md), a synthetic fixture. Shared shell: central circle and layered orbits. Contextual work view: **Operations board**.

1. Scaffold this profile using `scripts/new_workspace.py`.
2. Import `examples/worked/operations/input.md` using the CLI, or capture its text in the app.
...
4. Inspect the source and draft. Intake, draft and accepted records are distinct; no invented deadline or external tasks.
