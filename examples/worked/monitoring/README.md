...
Input: [input.md](input.md), a synthetic fixture. Shared shell: central circle and layered orbits. Contextual work view: **Anchored domain map**.

1. Scaffold this profile using `scripts/new_workspace.py`.
2. Import `examples/worked/monitoring/input.md` using the CLI, or capture its text in the app.
...
4. Inspect the source and draft. An observation is not an incident; the center stays fixed while evidence opens in an inspector.
